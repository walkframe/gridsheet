...
describe('rank.eq', () => {
  ...
  describe('normal', () => {
    ...
    it('returns top rank when ties exist (descending)', () => {
      const f = new RankEqFunction({ table, args: [new ValueEntity(20), new RangeEntity('A1:A4')] });
  ...
  describe('validation error', () => {
    it('throws when value not in range', () => {
      const f = new RankEqFunction({ table, args: [new ValueEntity(99), new RangeEntity('A1:A4')] });
