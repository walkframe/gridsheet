...
- **@gridsheet/functions**: Extended formula functions library. Provides `useSpellbook` / `createSpellbook` which bundle all built-in extended functions and accept custom `additionalFunctions`.
