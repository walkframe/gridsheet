---
title: "Case 7: Real-time Collaboration Interface"
---

import Case7 from '../../../components/case7.component';
...
<div class="not-content"><Case7 client:visible /></div>

<a href="https://github.com/walkframe/gridsheet/tree/master/packages/docs-astro/src/components/case7.component.tsx" target="_blank" rel="noopener noreferrer" style={{display: 'inline-block', background: '#007bff', color: 'white', padding: '8px 16px', textDecoration: 'none', borderRadius: '4px', fontWeight: '500', margin: '10px 0'}}>View Source Code</a>
