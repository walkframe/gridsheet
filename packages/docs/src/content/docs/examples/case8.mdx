---
title: "Case 8: Large Dataset Performance Demo"
---

import Case8 from '../../../components/case8.component';

This demo renders a grid with 500,000 rows and 10 columns (5,000,000 cells in total). GridSheet uses lazy initialization and deferred cell expansion internally, so the grid becomes interactive without processing all cells upfront.

<div class="not-content"><Case8 client:visible /></div>

## Implementation Guide

<a href="https://github.com/walkframe/gridsheet/tree/master/packages/docs-astro/src/components/case8.component.tsx" target="_blank" rel="noopener noreferrer" style={{display: 'inline-block', background: '#007bff', color: 'white', padding: '8px 16px', textDecoration: 'none', borderRadius: '4px', fontWeight: '500', margin: '10px 0'}}>View Source Code</a>
