---
title: "Case 10: Inventory Management with Events & Formulas"
---

import Case10 from '../../../components/case10.component';
...
<div class="not-content"><Case10 client:visible /></div>

## Implementation Guide

<a href="https://github.com/walkframe/gridsheet/tree/master/packages/docs-astro/src/components/case10.component.tsx" target="_blank" rel="noopener noreferrer" style={{display: 'inline-block', background: '#007bff', color: 'white', padding: '8px 16px', textDecoration: 'none', borderRadius: '4px', fontWeight: '500', margin: '10px 0'}}>📄 View Source Code</a>
