---
title: "Case 2: GitHub Contributors Dashboard"
---

import Case2, { AddressOverlayExample } from '../../../components/case2.component';
...
<div class="not-content"><Case2 client:visible /></div>

## Implementation Guide

<a href="https://github.com/walkframe/gridsheet/tree/master/packages/docs-astro/src/components/case2.component.tsx" target="_blank" rel="noopener noreferrer" style={{display: 'inline-block', background: '#007bff', color: 'white', padding: '8px 16px', textDecoration: 'none', borderRadius: '4px', fontWeight: '500', margin: '10px 0'}}>📄 View Source Code</a>
...
<div class="not-content"><AddressOverlayExample client:visible /></div>
