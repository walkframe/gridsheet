...
import { GridSheet, buildInitialCells, BaseFunctionAsync, Spilling, FormulaError } from '@gridsheet/react-core';
        ...
        initialCells={buildInitialCells({
          cells: {
            ...
            A1: {
              ...
              style: { ...cellBase, color: 'var(--gs-fg)', fontWeight: '600', fontSize: '11px' },
            },
            B1: { value: '=GH_REPO(A1)' },
            A2: {
            ...
            B2: { value: '=GH_REPO(A2)' },
            A3: {
              value: 'walkframe/jupyter-kit',
              style: { ...cellBase, color: 'var(--gs-fg)', fontWeight: '600', fontSize: '11px' },
            },
            B3: { value: '=GH_REPO(A3)' },
          },
          ensured: { numRows: 3, numCols: 4 },
        })}
        options={{
